...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at serac.build",
  ...
  "Serac auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Use Serac to create Business Rules, Client Scripts, and Script Includes",
  "Serac includes 54 bundled ServiceNow domain skills for ITSM, CMDB, Security, and more",
  "Serac has 200+ MCP tools for querying tables, deploying widgets, and managing Update Sets",
  "Use Serac to query any ServiceNow table with GlideRecord patterns",
  "Create {highlight}.ts{/highlight} files in {highlight}.snow-code/tool/{/highlight} to define new LLM tools",
  "Ask Serac to deploy widgets to Service Portal with automatic coherence validation",
  "Add {highlight}.ts{/highlight} files to {highlight}.snow-code/plugin/{/highlight} for event hooks",
  "Serac supports ServiceNow OAuth, Basic Auth, and Enterprise portal authentication",
  "Use Serac to manage Update Sets, track changes, and export XML",
  "Use {highlight}Blast Radius{/highlight} to see the full impact of changing a field, table, or artifact before you deploy",
  "Use {highlight}serac run{/highlight} for non-interactive scripting",
  "Use {highlight}serac --continue{/highlight} to resume the last session",
  "Use {highlight}serac run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}serac serve{/highlight} for headless API access to Serac",
  "Use {highlight}serac run --attach{/highlight} to connect to a running server",
  "Run {highlight}serac upgrade{/highlight} to update to the latest version",
  "Run {highlight}serac auth list{/highlight} to see all configured providers",
  "Run {highlight}serac agent create{/highlight} for guided agent creation",
  "Use {highlight}/oc{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}serac github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/oc fix this{/highlight} on issues to auto-create PRs",
  "Comment {highlight}/oc{/highlight} on PR code lines for targeted code reviews",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors',
  "Create JSON theme files in {highlight}.snow-code/themes/{/highlight} directory",
  "Ask Serac to create REST integrations and test them against your ServiceNow instance",
  "Use Serac Enterprise for Jira, Azure DevOps, and Confluence integrations",
  ...
  "Run {highlight}serac debug config{/highlight} to troubleshoot configuration",
