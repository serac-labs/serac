...
export default function TermsOfService() {
  return (
    <main data-page="legal">
      <Title>Serac | Terms of Service</Title>
      <Link rel="canonical" href={`${config.baseUrl}/legal/terms-of-service`} />
      <Meta name="description" content="Serac terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to Serac. Please read on to learn the rules and restrictions that govern your use of
                Serac (the "Services"). If you have any questions, comments, or concerns regarding these terms or
              ...
              <h2 id="what-is-snow-flow">What is Serac?</h2>
              <p>
                Serac is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the Serac Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Serac enables you to
              ...
              <h2 id="what-are-the-basics">What are the basics of using Serac?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Serac;
                </li>
                <li>
              ...
              <p>
                If you use Serac with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Serac. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                Serac has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-snow-flow-ever-change-the-services">Will Serac ever change the Services?</h2>
              <p>
              ...
              <p>
                Serac is also free to terminate (or suspend access to) your use of the Services for any reason in
                our discretion, including your breach of these Terms. Serac has the sole right to decide whether you
              ...
              <p>
                Serac and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (Serac and all such
                parties together, the "Serac Parties") make no representations or warranties concerning the
                Services, including without limitation regarding any Content contained in or accessed through the
                Services, and the Serac Parties will not be responsible or liable for the accuracy, copyright
                ...
                any way related to your participation in, the Services. The Serac Parties make no representations or
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Serac Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Serac's prior written
              ...
              <p>
                ...
                disputes and claims with Serac and limits the manner in which you can seek relief from Serac.
                Both you and Serac acknowledge and agree that for the purposes of any dispute arising out of or
                relating to the subject matter of these Terms, Serac's officers, directors, employees and
              ...
              <p>
                The Rules will govern payment of all arbitration fees. Serac will pay all arbitration fees for
                claims less than seventy-five thousand ($75,000) dollars. Serac will not seek its attorneys' fees
              ...
              <p>
                Either you or Serac may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                OF A JUDGE OR JURY. You and Serac are instead choosing to have claims and disputes resolved by
                ...
                you and Serac over whether to vacate or enforce an arbitration award, YOU AND SNOW-FLOW WAIVE ALL
              ...
              <p>
                ...
                Serac is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or Serac to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Serac agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the Serac may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and Serac agree that
                these Terms are the complete and exclusive statement of the mutual understanding between you and
                Serac, and that these Terms supersede and cancel all previous written and oral agreements,
                communications and other understandings relating to the subject matter of these Terms. You hereby
                acknowledge and agree that you are not an employee, agent, partner, or joint venture of Serac, and
                you do not have any authority of any kind to bind Serac in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and
                Serac agree there are no third-party beneficiaries intended under these Terms.
              </p>
            </article>
          </section>
        </div>
