...
Serac 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/serac-labs/serac/releases) 에서 직접 다운로드하거나 [github.com/serac-labs/serac/releases/latest](https://github.com/serac-labs/serac/releases/latest) 를 이용하세요.
